...
export const DuplexTrackingPdf = ({ t, dataBudget, dataDuplex }) => {
  ...
  const handleDownloadPDF = async () => {
    ...
    const pushTotalRow = (label, value) => [{ text: label, bold: true, colSpan: 3, alignment: "right" }, {}, {}, {}, { text: value.toFixed(2), bold: true, alignment: "right" }, {}];
    ...
    tableBody.push([
      ...
      { text: Number(dataDuplex.subTotalSpent).toFixed(2), bold: true, alignment: "right" },
      { text: totalReal.toFixed(2), bold: true, alignment: "right" },
    ]);
    tableBody.push(pushTotalRow("CONTRACTORS'S FEE", Number(dataDuplex.contractorsFee)));
    tableBody.push(pushTotalRow("TOTAL TO DATE", totalToDate));
    ...
    tableBody.push(pushTotalRow("BALANCE TO OPERATE", totalToDate - totalDeposit));
